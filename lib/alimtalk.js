...
const TPL_CANCEL_DONE = process.env.ALIMTALK_TEMPLATE_CANCEL_DONE || 'TEMPLATE_CANCEL_DONE';
const TPL_CHANGE      = process.env.ALIMTALK_TEMPLATE_CHANGE      || 'TEMPLATE_CHANGE';
...
변경된 티켓을 확인해 주세요.`;
  ...
  return sendAlimtalk(phone, text, templateCode || TPL_CHANGE, buttons);
}
...
문의사항은 카카오톡 채널로 연락해 주세요.`;
  ...
  return sendAlimtalk(phone, text, templateCode || TPL_CANCEL_DONE);
}
